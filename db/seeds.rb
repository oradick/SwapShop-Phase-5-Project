...
Listing.create!(creator_id: 1, recipient_id: 2, image: "https://cdn.shopify.com/s/files/1/0610/2745/1118/products/drinkcupsocks_product2_1_1_grande.jpg?v=1638620751", description: "in-n-out socks", size: "5-10", keywords: "clothes, socks", offer: true)
Listing.create(creator_id: 2, recipient_id: 3, image: "https://s7.orientaltrading.com/is/image/OrientalTrading/VIEWER_ZOOM/adult-s-classic-black-witch-hat~13654370", description: "witch's hat", size: "one size", keywords: "clothes, hat, costume", offer: true)
...
Listing.create(creator_id: 3, recipient_id: 4,  image: "https://cdn.shopify.com/s/files/1/0342/7431/2325/products/ACS-50LL_1_300x.jpg?v=1600372168", description: "leg lamp", size: "50 inches", keywords: "lamp, home", offer: true)
Listing.create(creator_id: 1, recipient_id: 3, image: "https://www.refinery29.com/images/10305026.png?format=pjpg&auto=webp&resize-filter=lanczos2&quality=50&sharpen=a3%2Cr3%2Ct0&optimize=low&width=960", description: "EVERLANE boxy black t-shirt", size: "M", keywords: "clothes, shirt", offer: true)
